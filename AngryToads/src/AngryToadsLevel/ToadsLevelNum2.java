...
public class ToadsLevelNum2 extends AngryToadsArea{
	...
	public void initStage(){
		...
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos1.x-1f,pos1.y+0.5f), 0.35f, 1, 0));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos1.x+1,pos1.y+0.5f), 0.35f, 1, 0));
		
		pos1.set(pos1.x,pos1.y+2f);
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos1, 2f, 0.2f, 0));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos1.x-1f,pos1.y+0.5f), 0.35f, 1f, 0));
		...
		pos1.set(pos1.x,pos1.y+2f);
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos1, 2f, 0.2f, 0));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 1, pos.set(pos1.x,pos1.y+0.5f), 1f, 1.5f, (float)Math.PI/2));
