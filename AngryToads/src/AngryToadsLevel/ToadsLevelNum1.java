...
public class ToadsLevelNum1 extends AngryToadsArea {
	...
	public void initStage() {
		...
		this.toadList.add(new AngryToadsEnemy().createEnemy(this.sworld, 0, pos));
		pos.set(38f, 3.6f);
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos.x, pos.y), 2f, 0.3f,
				(float) (Math.PI / 2)));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos.x + 4.1f, pos.y), 2f,
				0.3f, (float) (Math.PI / 2)));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos.x - 2.05f, pos.y + 2f),
				2.6f, 0.3f, 0));
		pos.set(55f, 2f);
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 1, pos, 2f, 5f, 0));
		toadBullets = 0;
